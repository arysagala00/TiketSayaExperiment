...
public class RegisterTwoAct extends AppCompatActivity {
    LinearLayout btn_back_dua;
    Button btn_continue_dua, btn_add_photo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back_dua = findViewById(R.id.btn_back_dua);
        btn_continue_dua = findViewById(R.id.btn_continue_dua);
        ...
        btn_back_dua.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onBackPressed();
            }
        ...
        btn_continue_dua.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Membuat tombol disable
                btn_continue_dua.setEnabled(false);
